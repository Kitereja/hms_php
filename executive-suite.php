...
<head>
    ...
    <title>Executive Suites - Hotel De Mag</title>
    <link rel="stylesheet" href="css/global.css">
    <link rel="stylesheet" href="css/rooms-shared.css">
    <link rel="stylesheet" href="css/executive-suite.css">
...
<header class="rooms-header">
    ...
    <p>The pinnacle of luxury — spacious, opulent and unforgettable</p>
</header>

<a href="room.php" class="back-link">← Back to All Rooms</a>
...
<section class="room-type-section">
    ...
    <div class="room-gallery">
        ...
        <?php if ($room_count === 0) : ?>
            ...
            <p class="no-rooms">
                No executive suites are available at the moment.
            </p>
                ...
                <div class="room-card">
                    ...
                    <div class="room-card-info">
                        ...
                        <div class="room-amenities">
                            ...
                            <span><i class="fas fa-glass-martini-alt"></i> Mini Bar</span>
                            <span><i class="fas fa-couch"></i> Lounge</span>
...
<div class="modal-overlay" id="bookingModal" onclick="closeModalOutside(event)">
    <div class="modal-box">
        ...
        <form action="booking_process.php" method="POST">
            ...
            <input type="hidden" name="room_name" id="roomNameInput">
            <input type="hidden" name="price_per_night" id="roomPriceInput" value="0">
            ...
            <div class="form-group">
                ...
                <input type="email" name="guest_email" placeholder="e.g. john@email.com" required>
            </div>
...
function openModal(roomId, roomName, price) {
    ...
    document.getElementById('modalRoomPrice').textContent = 'TSH ' + price + '/night';
